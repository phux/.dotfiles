...
<CONTEXT>
You MUST consult the following knowledge base of evaluated prompt optimization techniques sourced from Google's official documentation (applicable for March 2026 frontier models):
