...
plugins=(git docker docker-compose colored-man-pages gitfast golang history-substring-search tmux tmuxinator zsh-completions)
...
PATH=$PATH:~/.config/composer/vendor/bin:~/bin
